...
import com.ar.evan.arnavigation.view.ARCamera;
import com.ar.evan.arnavigation.view.AROverlayView;
...
public class ARActivity extends AppCompatActivity implements SensorEventListener, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ArrayList<LocationInfoBean> listObj =  (ArrayList<LocationInfoBean>) getIntent().getSerializableExtra("locationInfoBeanList");

        for(LocationInfoBean locationInfoBean:locationInfoBeanList){
            ARPoint  arPoint=new ARPoint(locationInfoBean.getLocationName(),locationInfoBean.getLatitude(),locationInfoBean.getLongitude(),locationInfoBean.getAltitude());
